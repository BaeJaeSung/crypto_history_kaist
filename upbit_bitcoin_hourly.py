...
def fetch_upbit_btc_hourly_history():
    url = "https://api.upbit.com/v1/candles/minutes/60"  # 60분(1시간) 단위 데이터
...
# 데이터 가져오기
btc_hourly_data = fetch_upbit_btc_hourly_history()

# 데이터 확인
print(btc_hourly_data.head())

# CSV로 저장
btc_hourly_data.to_csv('upbit_btc_hourly_history.csv', index=False)
